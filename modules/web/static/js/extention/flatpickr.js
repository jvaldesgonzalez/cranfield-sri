...
!(function (e, t) {
  ...
  function r(d, s) {
    ...
    function l(e) {
      ...
      try {
        void 0 !== t &&
          ((h.currentYear = t.getFullYear()), (h.currentMonth = t.getMonth()));
      } catch (e) {
    ...
    function x() {
      ...
      i.setAttribute("aria-label", h.l10n.yearAriaLabel),
        h.config.minDate &&
          i.setAttribute("data-min", h.config.minDate.getFullYear().toString()),
        h.config.maxDate &&
          (i.setAttribute(
            "data-max",
    ...
    function N(e, t) {
      ...
      if (
        (h.config.minDate &&
          n &&
          ce(n, h.config.minDate, void 0 !== t ? t : !h.minDateHasTime) < 0) ||
        (h.config.maxDate &&
          n &&
    ...
    return (
      (function () {
        (h.element = h.input = d),
          ...
          (function () {
            if (
              ((h.input = h.config.wrap ? d.querySelector("[data-input]") : d),
              !h.input)
            )
              ...
              if (
                ...
                if (
                  ...
                  var t = (function () {
                      ...
                      e.appendChild(
                        me("span", "flatpickr-weekday", h.l10n.weekAbbreviation)
                      );
  ...
  var ve = function (e, t) {
    return e instanceof NodeList
      ? n(e, t)
      : n("string" == typeof e ? window.document.querySelectorAll(e) : [e], t);
  };
  return (
    (ve.defaultConfig = C),
    (ve.l10ns = { en: Object.assign({}, oe), default: Object.assign({}, oe) }),
